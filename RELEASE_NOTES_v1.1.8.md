# 4x-ui v1.1.8 — Latest Release and Complete Project Details
...
- v1.1.8 adds no-op detection: an unchanged healthy OpenSSH configuration is
...
4x-ui v1.1.8 adds a native Go payload gateway directly to Xray WebSocket
...
Pushing a semantic tag such as `v1.1.8` triggers the binary and Docker release
flows according to the workflow definitions.

## Repository cleanup in this package

- Only `RELEASE_NOTES_v1.1.8.md` is kept.
