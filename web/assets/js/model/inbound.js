...
Inbound.VmessSettings.VMESS = class extends Inbound.ClientBase {
    constructor(
        ...
        email, limitIp, totalGB, expiryTime, enable, tgId, subId, comment, reset, speedLimit, downloadMbps, uploadMbps, created_at, updated_at,
    ) {
        super(email, limitIp, totalGB, expiryTime, enable, tgId, subId, comment, reset, speedLimit, downloadMbps, uploadMbps, created_at, updated_at);
        this.id = id;
        this.security = security;
    }
