...
Inbound.ClientBase = class extends XrayCommonClass {
    constructor(
        ...
        this.maxSessions = Math.max(0, Number(maxSessions || 0));
...
Inbound.VmessSettings.VMESS = class extends Inbound.ClientBase {
    constructor(
        ...
        email, limitIp, maxSessions, totalGB, expiryTime, enable, tgId, subId, comment, reset, speedLimit, downloadMbps, uploadMbps, created_at, updated_at,
    ) {
        super(email, limitIp, maxSessions, totalGB, expiryTime, enable, tgId, subId, comment, reset, speedLimit, downloadMbps, uploadMbps, created_at, updated_at);
        this.id = id;
        this.security = security;
    }
