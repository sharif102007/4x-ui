...
// syncTrafficShaper brings queue shaping in line with whether any speed limit
// is currently configured. Safe to call on every policy application; it only
// shells out when the desired state actually changes.
