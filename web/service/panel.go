...
func (s *PanelService) StartUpdate() error {
	...
	updateScript := fmt.Sprintf("set -o pipefail; %s -fLs https://raw.githubusercontent.com/sharif102007/4x-ui/main/update.sh | %s", shellQuote(curl), shellQuote(bash))
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/sharif102007/4x-ui/releases/latest")
	if err != nil {
		return "", err
	}
