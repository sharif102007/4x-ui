...
func (s sshSystem) applySshdPorts(ports []int, banners map[int]string) error {
	...
	// Keep mobile/NAT tunnels alive and allow short reconnect bursts without
	// changing authentication or forwarding behavior.
	sb.WriteString("TCPKeepAlive yes\n")
	sb.WriteString("ClientAliveInterval 30\n")
	sb.WriteString("ClientAliveCountMax 3\n")
	sb.WriteString("MaxSessions 100\n")
	sb.WriteString("MaxStartups 100:30:200\n")
