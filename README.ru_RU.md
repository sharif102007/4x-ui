...
```
bash <(curl -Ls https://raw.githubusercontent.com/sharif102007/4x-ui/master/install.sh)
```

Полную документацию смотрите в [вики проекта](https://github.com/sharif102007/4x-ui/wiki).
