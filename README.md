...
- [v1.1.9 release notes](./RELEASE_NOTES_v1.1.9.md)

Linux releases target `x86_64/amd64` VPS hosts. The same static release asset
supports Debian, Ubuntu, and AlmaLinux; separate builds per distribution are
not required.
