...
type Client struct {
	...
	MaxSessions  int            `json:"maxSessions" form:"maxSessions"`   // Maximum concurrent sessions (0 = unlimited)
	...
	SpeedLimit   bool           `json:"speedLimit" form:"speedLimit"`     // Whether per-client bandwidth limiting is enabled
	DownloadMbps int            `json:"downloadMbps" form:"downloadMbps"` // Maximum client download speed in Mbit/s
	UploadMbps   int            `json:"uploadMbps" form:"uploadMbps"`     // Maximum client upload speed in Mbit/s
