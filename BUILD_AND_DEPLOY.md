...
and Windows package. A version tag such as `v1.1.10` uploads the archives to the
matching GitHub Release.

```bash
git add .
git commit -m "release v1.1.10"
...
commands to push the repository and the `v1.1.10` tag. Pushing the tag triggers
