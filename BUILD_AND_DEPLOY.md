...
and Windows package. A version tag such as `v1.1.8` uploads the archives to the
...
commands to push the repository and the `v1.1.8` tag. Pushing the tag triggers
