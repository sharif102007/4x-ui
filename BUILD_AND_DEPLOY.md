...
and Windows package. A version tag such as `v1.1.9` uploads the archives to the
...
commands to push the repository and the `v1.1.9` tag. Pushing the tag triggers
